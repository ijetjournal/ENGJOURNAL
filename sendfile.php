...
function sendMailAsAttachment( $filename, $fileorgname, $formData ) {
    ...
    //$ok = mail("editorijetjournal@gmail.com", "Article", "test", "From: admin@admin.com");
    if ($ok) {

        echo '<script language="javascript">';
echo 'alert("Your Message successfully sent, we will get back to you ASAP.");';
echo 'window.location.href="http://www.ijretjournal.org/upload.html";';
echo '</script>';
